declare module "@devzolo/node-native-gl" {
	export namespace GL {
		/* AccumOp */
		const ACCUM = 0x0100;
		const LOAD = 0x0101;
		...
		function colorMask(
			red: GLboolean | number,
			green: GLboolean | number,
			blue: GLboolean | number,
			alpha: GLboolean | number,
		): void;
		...
		function getTexLevelParameteriv(
			target: GLenum,
			level: GLint,
			pname: GLenum,
			params: GLint[],
		...
		function compressedTexSubImage1D(
			target: GLenum,
			level: GLint,
			xoffset: GLint,
			width: GLsizei,
		...
		function secondaryColor3d(
			red: GLdouble,
			green: GLdouble,
			blue: GLdouble,
		): void;
		function secondaryColor3dv(v: GLdouble[]): void;
		function secondaryColor3f(
			red: GLfloat,
			green: GLfloat,
			blue: GLfloat,
		): void;
		...
		function secondaryColor3s(
			red: GLshort,
			green: GLshort,
			blue: GLshort,
		): void;
		function secondaryColor3sv(v: GLshort[]): void;
		function secondaryColor3ub(
			red: GLubyte,
			green: GLubyte,
			blue: GLubyte,
		): void;
		...
		function secondaryColor3us(
			red: GLushort,
			green: GLushort,
			blue: GLushort,
		): void;
		function secondaryColor3usv(v: GLushort[]): void;
		function secondaryColorPointer(
			size: GLint,
			type: GLenum,
			stride: GLsizei,
			pointer: [],
		...
		function texParameterIiv(
			target: GLenum,
			pname: GLenum,
			params: GLint[],
		): void;
		function texParameterIuiv(
			target: GLenum,
			pname: GLenum,
			params: GLuint[],
		): void;
		...
		//GL_VERSION_4_0
		function blendEquationSeparatei(
			buf: GLuint,
			modeRGB: GLenum,
			modeAlpha: GLenum,
		): void;
		function blendEquationi(buf: GLuint, mode: GLenum): void;
		function blendFuncSeparatei(
			buf: GLuint,
			srcRGB: GLenum,
			dstRGB: GLenum,
			srcAlpha: GLenum,
		...
		function getnCompressedTexImage(
			target: GLenum,
			lod: GLint,
			bufSize: GLsizei,
			pixels: GLvoid[],
		): void;
		function getnTexImage(
			tex: GLenum,
			level: GLint,
			format: GLenum,
			type: GLenum,
		...
		//GL_VERSION_4_6
		function multiDrawArraysIndirectCount(
			mode: GLenum,
			indirect: [],
			drawcount: GLintptr,
		...
		function multiDrawElementsIndirectCount(
			mode: GLenum,
			type: GLenum,
			indirect: [],
			drawcount: GLintptr,
		...
		function specializeShader(
			...
			pConstantIndex: GLuint[],
			pConstantValue: GLuint[],
		): void;
	}
	export default GL;
}
